    ...
    <section className="bg-[#FAFAFA] min-h-screen py-12 px-6 sm:px-10 lg:px-20 xl:px-32 overflow-hidden">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-6 sm:p-10 lg:p-12 border border-gray-100">
        ...
        <div className="space-y-6 text-[#494848] leading-relaxed text-sm sm:text-base">
          ...
          <p>Welcome to Bonne Sante!</p>

          <p>
            These terms and conditions outline the rules and regulations for the use
            of Bonne Sante&apos;s website, located at {" "}
            <a
              href="https://www.bonnesante.co.in/"
              target="_blank"
          ...
          <p>
            ...
            conditions. Do not continue to use Bonne Sante if you do not agree to
          ...
          <p>
            ...
            &quot;We&quot;, &quot;Our&quot;, and &quot;Us&quot; refer to Bonne Sante. &quot;Party&quot;, &quot;Parties&quot;, or &quot;Us&quot; refer
          ...
          <p>
            We employ the use of cookies. By accessing Bonne Sante, you agree to
            use cookies in accordance with Bonne Sante&apos;s Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, Bonne Sante and/or its licensors own the
            intellectual property rights for all material on Bonne Sante. All
            intellectual property rights are reserved. You may access this from
            Bonne Sante for your own personal use subject to the restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>Republish material from Bonne Sante;</li>
            <li>Sell, rent, or sub-license material from Bonne Sante;</li>
            <li>Reproduce, duplicate, or copy material from Bonne Sante;</li>
            <li>Redistribute content from Bonne Sante.</li>
          </ul>
          ...
          <p>
            ...
            exchange opinions and information in certain areas of the website. Bonne Sante does not filter, edit, publish, or review Comments prior to their
            presence on the website. Comments do not reflect the views or opinions
            of Bonne Sante, its agents, and/or affiliates. Comments reflect the
            views and opinions of the person who posts them. To the extent permitted
            by applicable law, Bonne Sante shall not be liable for the Comments or
          ...
          <p>
            ...
            the hyperlink compensates the absence of Bonne Sante; and (d) the link
          ...
          <p>
            No use of Bonne Sante&apos;s logo or other artwork will be allowed for
